                  ...
                  <div>
                    ...
                    <div className="relative mt-2.5">
                      <input
                        ...
                        className="block w-full rounded-md border border-gray-200 bg-white px-4 py-4 text-black placeholder-gray-400 caret-orange-500 transition-all duration-200 focus:border-orange-500 focus:outline-none focus:ring-orange-500"
                      />
                    </div>
                  </div>
                  <div>
                    <button
                      type="submit"
                      disabled={loading}
                      className="inline-flex w-full items-center justify-center rounded-md border border-transparent bg-teal-400 px-4 py-4 text-base font-semibold text-white transition-all duration-200 hover:bg-teal-200 focus:bg-orange-600 focus:outline-none disabled:bg-teal-100"
                    >
